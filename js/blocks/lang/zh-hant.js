...
export const MSG_ZH_HANT = {
    ...
    'SB_SET_INSTRUMENT_VIBRATO_MESSAGE': '設定音源顫音 %1',
    'SB_SET_INSTRUMENT_VIBRATO_TOOLTIP': '設定目前音源的音高偏移效果（顫音），單位為「音分 (cents)」。',
    'SB_SET_INSTRUMENT_VOLUME_MESSAGE': '設定音源音量 %1',
    'SB_SET_INSTRUMENT_VOLUME_TOOLTIP': '設定目前音源的輸出音量，建議範圍 0 到 1。',
