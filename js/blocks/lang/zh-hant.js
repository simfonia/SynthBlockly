...
export const MSG_ZH_HANT = {
    ...
    'MSG_SOUND_SOURCES_CATEGORY': '創建樂器 (Instruments)',
    ...
    'MSG_CREATE_ADDITIVE_SYNTH_MESSAGE': '建立自訂加法合成音源',
    'MSG_CREATE_ADDITIVE_SYNTH_TOOLTIP': '建立一個由多個獨立振盪器疊加而成的加法合成音源。必須放置於「定義樂器」容器內。',
