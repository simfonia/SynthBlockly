...
// --- Signal Chain ---
// Chain instruments through effects to the analyser
...
jazzKit.chain(distortionEffect, feedbackDelayEffect, reverbEffect, analyser);
...
export const audioEngine = {
    ...
    createInstrument: function(name, type) {
        ...
        try {
            ...
            // All new instruments must also be chained to the effects and analyser
            newInstrument.chain(distortionEffect, feedbackDelayEffect, reverbEffect, analyser);
